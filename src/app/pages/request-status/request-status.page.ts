...
export class RequestStatusPage implements OnInit {
	...
	ngOnInit() {
		this.title = this.requestService.currentRequestStatus && this.requestService.currentRequestStatus.length && this.requestService.currentRequestStatus[0].type === ReclamationType.REQUEST ? 'Demande' : 'Dérangement';
	}
