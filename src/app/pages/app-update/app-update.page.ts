...
export class AppUpdatePage implements OnInit {
  ...
  Pour profiter des dernières fonctionnalités, Mettez la à jour.`;
	...
	ngOnInit() {
		this.appId = history.state && history.state.appId ? history.state.appId : null;
		this.forceUpdate = history.state && history.state.forceUpdate ? history.state.forceUpdate : null;
	}
