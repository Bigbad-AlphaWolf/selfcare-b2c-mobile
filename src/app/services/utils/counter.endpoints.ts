...
export const XEWEUL_SOLDE_ENDPOINT = `${XEWEUL_PATH}/cards/${'msisdn'}/balance`;
export const XEWEUL_SAVE_CARD_ENDPOINT = `${XEWEUL_PATH}/cards`;
export const XEWEUL_PAYMENT_ENDPOINT = `${XEWEUL_PATH}/cards`;
