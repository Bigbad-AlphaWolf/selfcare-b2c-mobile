...
import { OPERATION_SEE_SOLDE_RAPIDO, OPERATION_TYPE_PASS_ALLO, OPERATION_TYPE_PASS_ILLIFLEX, OPERATION_TYPE_PASS_ILLIMIX, OPERATION_TYPE_PASS_INTERNET, OPERATION_TYPE_PASS_VOYAGE, OPERATION_TYPE_RECHARGE_CREDIT } from 'src/shared';
  ...
  logRecipientOnFollow(purchaseType: string, infos: any, isLightMod?: boolean) {
    ...
    switch (purchaseType) {
      case OPERATION_TYPE_RECHARGE_CREDIT:
        ...
        payload = { sender: infos.senderMsisdn, recipient: infos.recipientMsisdn, operation: purchaseType.toLowerCase() }
        break;
