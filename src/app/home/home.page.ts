...
export class HomePage implements OnInit {
  ...
  goToLoginPage() {
    this.oemLogging.registerEvent('home_login_click', null);
    this.router.navigate(['/login']);
  }

  goToRegistrationPage() {
    this.oemLogging.registerEvent('home_direct_access_click', null);
  ...
  forgotPwd() {
    this.oemLogging.registerEvent('home_reset_password_click', null);
