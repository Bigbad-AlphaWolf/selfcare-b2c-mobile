...
export class ModalSuccessComponent implements OnInit {
  ...
  closeDialog() {
    ...
    if (
      this.data.type === 'changePassword' ||
      this.data.type === 'sargal-success' ||
      this.data.type === 'sargal-failed' ||
      this.data.type === 'survey'
    ) {
      ...
      this.data.type !== 'sargal-already-registered' &&
      this.data.type !== 'rattachment-success' &&
      this.data.type !== 'rattachment-failed'
    ) {
      this.navCont.pop();
    }
  }
