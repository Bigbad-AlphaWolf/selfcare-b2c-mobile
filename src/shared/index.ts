...
export const OPERATION_CONFIRM_RATTACHMENT = 'OPERATION_CONFIRM_RATTACHMENT';
export const OPERATION_CREATE_REQUEST_DEMANDE_TICKET = 'OPEN_REQUEST_DEMANDE_TICKET';
...
export const CREATE_TROUBLE_TICKET = 'REQUESTS';

export const PAYMENT_MOD_CREDIT = 'CREDIT';
export const PAYMENT_MOD_OM = 'ORANGE_MONEY';
export const PAYMENT_MOD_BANK_CARD = 'BANK_CARD';
...
export const JAMONO_NEW_SCOOL_SWAP_FORMULE_PATH = 'swapscool';
